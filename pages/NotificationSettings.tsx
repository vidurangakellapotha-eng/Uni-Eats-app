    ...
    if (loading) {
        return (
            <div className="flex flex-col items-center justify-center min-h-screen bg-slate-50 dark:bg-zinc-950">
                <span className="material-icons-round text- primary animate-spin text-4xl">settings</span>
            </div>
        );
    }
    ...
    return (
        <div className="flex flex-col min-h-screen bg-slate-50 dark:bg-zinc-950">
            ...
            <header className="px-6 py-4 flex items-center gap-4">
                ...
                <h1 className="text-xl font-bold text-slate-900 dark:text-white tracking-tight">Notification Settings</h1>
            </header>
