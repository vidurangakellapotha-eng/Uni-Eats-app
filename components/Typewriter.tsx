...
const Typewriter: React.FC<{ segments: TypingSegment[] }> = ({ segments }) => {
    ...
    return (
        <h1 className="text-4xl font-display font-black text-slate-900 dark:text-white leading-[1.1] tracking-tight min-h-[1.1em]">
            ...
            <span className={`inline-block w-[3px] h-[1em] bg-orange-500 ml-1 align-middle ${completedSegments === segments.length ? 'animate-pulse' : 'animate-pulse'}`}></span>
        </h1>
    );
};
